...
chrome.tabs.query({ active: true, currentWindow: true }, (tabs)  => {
    chrome.tabs.sendMessage(tabs[0].id, { action: "getSelectedText" }, (response) => {
        if(response && response.text) {
            ...
            fetch(`https://generativelanguage.googleapis.com/v1/models/gemini-pro:generateContent?key=AIzaSyAfWR7WDUlcTcD1mjBwTRlKLV1jIfV19WQ`, {
                method : "POST",
                headers : {
                ...
                text.innerHTML = "Sorry, an error occurred"
            })
